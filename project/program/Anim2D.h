...
public:
	...
	//-----ロード系-----
	void LoadFrames(const std::string& path,int a_firstFrame,int a_lastFrame, float duration = 0.2f,float exRate = 1.0f, PlayMode playMode = PlayMode::Loop);
	...
	void Update();
	void Render(const Vector2Df& pos);
private:
